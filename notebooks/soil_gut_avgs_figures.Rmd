---
title: "Soil and gut AVG figures"
...
```{r q1-annotation-status-euler, fig.width=8, fig.height=4}
library(eulerr)
avg_div_base <- mast
q1_euler <- c(
...
```{r q3-sequence-similarity-invisible, fig.width=16, fig.height=4}
q3 <- q3_hi %>%
...
```{r inventory-by-category, fig.width=12, fig.height=8}
...
```{r assignment-depth, fig.width=4, fig.height=8}
...
```{r upset-novel, fig.width=16, fig.height=6}
ups <- nvm %>%
...
```{r avg-umap-pure, fig.width=6.5263, fig.height=8}
set.seed(20260611)
pp  <- umap_pts
lab <- clusters
...
```{r ecosystem-partition, fig.width=9.4737, fig.height=9}
...
```{r within-eco-combined, fig.width=12, fig.height=9}
p_eco_combined <-
...
```{r within-host-combined, fig.width=12, fig.height=9}
p_host_combined <-
...
```{r combined-summary, fig.width=16, fig.height=18}
...
```{r soil-gut-ecology-combined,  fig.width=16, fig.height=9}
...
```{r annotation-status-euler, fig.width=8, fig.height=4}
library(eulerr)
